...
const ProductDetail = ({product}) => {
    ...
    return (
        <>
            ...
            <Box>
                <Typography><Badge/>10% instant discount on SBI Mastercard Debit Cards, up to ₹250 on orders of ₹2,500 and above T&C</Typography>
                <Typography><Badge/>5% Cashback on Flipkart Axis Bank Card T&C</Typography>
                <Typography><Badge/>Buy this product and Get Extra 10% Up to ₹500 off on Home & Kitchen Appliances Know More</Typography>
                ...
                <Typography><Badge/>No Cost EMI on Bajaj Finsery EMI cart value abouve ₹2999  T&C</Typography>
            </Box>  
        </>
    );
};
